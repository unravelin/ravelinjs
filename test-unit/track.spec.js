      ...
      xhook.before(function (req) {
        ...
        r.core
          ...
          .then(function (ids) {
            ...
            expect(loadEvent.eventData).to.eql({
              eventName: 'PAGE_LOADED',
              properties: { section: 'manually-invoked' },
            });
            expect(loadEvent.eventMeta.trackingSource).to.equal('browser');
            expect(loadEvent.eventMeta.ravelinDeviceId).to.equal(ids.device);
            expect(loadEvent.eventMeta.ravelinSessionId).to.equal(ids.session);
    ...
    $([
      ...
      },
      {
        ...
        props: {
          ...
          selectionStart: 0,
          selectionEnd: 0,
          pastedValue: '0000 0000 0000 000',
          panCleaned: true,
        },
      },
      {
      ...
      },
      {
        ...
        props: {
          ...
          selectionStart: 0,
          selectionEnd: 0,
          pastedValue: '0000 0000-0000 0000 0',
          panCleaned: true,
        },
      },
      {
        ...
        props: {
          ...
          selectionStart: 0,
          selectionEnd: 0,
          pastedValue: '0000 0000 0000 0000 00',
          panCleaned: true,
        },
      },
      {
        ...
        props: {
          ...
          selectionStart: 0,
          selectionEnd: 0,
          pastedValue: '0000 0000 0000 0000 000',
          panCleaned: true,
        },
      },
      {
        ...
        props: {
          ...
          selectionStart: 0,
          selectionEnd: 0,
          pastedValue: '0000 0000 0000 0000 0000',
          panCleaned: false,
        },
      },
      {
      ...
      it('sends redacted paste events of ' + JSON.stringify(test), function (done) {
        ...
        xhook.before(function (req) {
          ...
          if (
            ...
            !event.events ||
            !event.events[0] ||
            event.events[0].eventType !== 'paste'
          ) {
            return { status: 204 };
          }
