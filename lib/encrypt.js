 ...
 *
 * @param {Card} card
 * @param {boolean} [noReportError=false] Dont report errors to Ravelin.
 * @return {EncryptedCard}
 */
Encrypt.prototype.card = function(card, noReportError) {
  // Wrap the call in error-reporting.
  if (this.core && !noReportError) {
    try {
      return this.card(card, true);
    } catch (e) {
      this.core.reportError(e);
      throw e;
    }
  }
